...
/**
 * Обучатель нейросети методом BFGS, в котором шаг выбирается методом парабол.
 * <p/>
 ...
 */
public class BfgsParabolicNNetTrainer extends ParabolicNNetTrainer {
     ...
     * Конструктор.
     */
    public BfgsParabolicNNetTrainer() {
        super(600);
    }
    ...
    protected double step(final int n, final double g2) {
        ...
        final double h = stepByParabolic(n, p2, gp);
    ...
    public String toString() {
        return String.format(Locale.US, "BfgsParabolicNNetTrainer: defaultCycles = %d, mu = %.4f", maxCycles, mu);
    }
}